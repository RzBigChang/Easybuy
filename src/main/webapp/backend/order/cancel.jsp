		...
		<div class="m_content">
			...
			<div class="m_right" id="content">
				...
				<table border="0" class="order_tab"
					...
					<tbody>
	 <form action="OrderServlet?action=Update" method="post" onsubmit="return check()">
    	<table border="0" width="40%" align="center">
    		...
    		<tr>
    			<td>取消订单的原因:</td>
    			<td><textarea name="txtMessage" style="width:200px;height:80px;">填写原因！！！</textarea></td>
    		</tr>
    		<tr>
    	    	<td colspan="4" align="center">
    	    	<input type="submit" name="sub" value="提  交" style="margin-right:40px"></input>
    	    	</td>
    	    </tr>
    	</table>
    </form>
