...
<%
	EasybuyUser list = (EasybuyUser) request.getAttribute("user");
	if (list == null) {
		String conPath = request.getContextPath();
		out.print("<script>location.href = '" + conPath + "/userIndex'</script>");
						...
						<tr valign="top">
							...
							<td>
								...
								<p>
									...
									上一次登录时间: 2019-11-28 2:19:47<br /> 您已通过邮箱验证！！！ <a href="#"
										style="color: #ff4e00;"></a>
								</p>
