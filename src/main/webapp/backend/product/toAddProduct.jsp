...
<%
	EasybuyProduct modify = (EasybuyProduct) request.getAttribute("easybuyProduct");
	if (modify == null) {
		String conPath = request.getContextPath();
		out.print("<script>location.href = '" + conPath + "/getCategoryList'</script>");
	}
%>
</head>
	...
	<div class="i_bg bg_color">
		...
		<div class="m_content">
			...
			<div class="m_right" id="content" style="font-weight: bolder;">
				...
				<br>
				<form action="${ctx }/getImgs" method="GET"
					id="productAdd">
