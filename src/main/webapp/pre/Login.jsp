			...
			<div class="log_c">
				<form action="javascript:;" method="post">
					<table border="0"
						...
						<tr height="70">
							<td>用户名</td>
							<td><input type="text" name="txtName" value="" class="l_user" maxlength="18" placeholder="用户名"/></td>
						</tr>
						<tr height="70">
							<td>密&nbsp; &nbsp; 码</td>
							<td><input type="password" name="pwdpassword" value="" class="l_pwd"  maxlength="16" placeholder="密码"/></td>
						</tr>
