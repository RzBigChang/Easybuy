    ...
    <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
        ...
        <c:forEach items="${sessionScope.cart.items}" var="temp">
            <tr>
                <td>
                    <div class="c_s_img">
                        <a href="${ctx}/queryProductDeatil?id=${temp.product.id}"><img src="${ctx}/files/${temp.product.fileName}" width="73" height="73"/></a>
                    </div>
                        ${temp.product.name}
                </td>
        ...
        <tr valign="top" height="150">
            <td colspan="6" align="right">
                <a href="${ctx}/zhu"><img src="${ctx}/statics/images/buy1.gif" /></a>&nbsp;&nbsp;
