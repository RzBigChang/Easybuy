				...
				<form action="javascript:;" method="post">
					<table border="0"
						...
						<tr height="50">
							...
							<td><input type="text" value="" id="luser" name="loginName" class="l_user" maxlength="16" placeholder="用户名就是是用来登陆得账号"/></td>
						</tr>
						...
						<tr height="50">
							<td align="right"><font color="#ff4e00">*</font>&nbsp;密码
								&nbsp;</td>
							<td><input type="password" value="" class="l_pwd" id="pwd" name="password" maxlength="18" placeholder="6~16位字符，区分大小写"/></td>
						</tr>
						...
						<tr height="50">
							<td align="right"><font color="#ff4e00">*</font>&nbsp;真实姓名
								&nbsp;</td>
							<td><input type="text" value="" name="userName" class="l_num" maxlength="16" placeholder="输入您得姓名"/></td>
						</tr>
						...
						<tr height="50">
							...
							<td><input type="text" value="" name="identityCode" class="l_mem" maxlength="18" placeholder="输入您得身份证号码"/></td>
						</tr>
						...
						<tr height="50">
							<td align="right"><font color="#ff4e00"></font>&nbsp;邮箱
								&nbsp;</td>
							<td><input type="text" value="" name="email" class="l_email" maxlength="25" placeholder="请输入您的常用邮箱"/></td>
						</tr>
						...
						<tr height="50">
							<td align="right"><font color="#ff4e00"></font>&nbsp;手机
								&nbsp;</td>
							<td><input type="text" value="" name="mobile" class="l_tel" maxlength="11" placeholder="手机号码"/></td>
						</tr>
