...
<div class="soubg">
	<div class="sou">
        ...
        <!-- 获取登陆用户昵称 -->
        <c:if test="${sessionScope.easybuyUserLogin!=null}">
            <span class="fl"><a href="${ctx }/index" style="color: red;font-weight: bolder;">${sessionScope.easybuyUserLogin.userName}</a>&nbsp;|&nbsp;<a href="${ctx}/index?userId=${sessionScope.easybuyUserLogin.id}">我的订单</a>&nbsp;</span>
          </c:if>
          <!-- 管理员登陆显示 -->
          <c:if test="${sessionScope.easybuyUserLogin!=null && sessionScope.easybuyUserLogin.type==1}">
            <span class="fl">|&nbsp;<a href="${ctx }/category">后台管理</a>&nbsp;</span>
          </c:if>
          <!-- 登陆成功出现注销功能！没登录没有。。 -->
          <c:if test="${sessionScope.easybuyUserLogin!=null}">
        	...
        	<span class="ss">
            	...
            	<div class="ss_list">
                    ...
                    <div class="ss_list_bg">
                        ...
                        <div class="ss_list_c">
                        	<ul>
                            	<li><a href="${ctx}/queryProductList4">收藏的宝贝</a></li>
                 ...
                 <div>
                <li><a href="${ctx }/pre/Fankui.jsp">用户反馈</a></li>
                </div>
...
<div class="ass">
    ...
    <a href="javascript: $('.win6').hide()" style="background-color: white"><img src="${ctx}/statics/images/jiaweixin1.png" height="580" width="500"></a>
